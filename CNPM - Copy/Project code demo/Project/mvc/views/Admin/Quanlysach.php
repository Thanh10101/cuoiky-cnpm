                        ...
                        <tbody>
                            ...
                            <?php
                              ...
                              $row=json_decode($string);
                                ...
                                <a href="http://localhost/project/Admin/Xoasanpham/'.$row[$i]->idsanpham.'" class="btn btn-success btn-block">Xóa <i class="fa fa-trash-o"></i></a>
                                <a href="http://localhost/project/Admin/Capnhatsanpham/'.$row[$i]->idsanpham.'" class="btn btn-success btn-block">Cập nhật <i class="fa fa-pencil-square-o"></i></a>

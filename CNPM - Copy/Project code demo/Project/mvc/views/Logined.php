...
if(!isset($_SESSION['id'])){
    header("Location:http://localhost/Project/Logined/Dangnhap");
}
...
<head>
    <base href="http://localhost/Project/Trangchu">
    <meta charset="UTF-8">
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="navbar-item">
                                <a href="http://localhost/Project/Logined/Xemthongtin" class="nav-link">
                                    <?php
                            ...
                            <li class="navbar-item">
                                <a href="http://localhost/Project/Logined/Dangxuat" class="nav-link">Đăng xuât</a>
                            </li>
                        </ul>
                        <div class="cart my-2 my-lg-0">
                            <a href="http://localhost/Project/Logined/Giohang">
                                <span>

                    ...
                    <table id="cart" class="table table-hover table-condensed">
                         ...
                         if(!empty($_SESSION["cart"])){
                            ...
                            for($i=0;$i<count($row);$i++){
                             ...
                             echo          '</div>
                                   ...
                                   <a href="http://localhost/project/Logined/Xoasanpham/'.$row[$i]->idsanpham.'" class="btn btn-success btn-block">Xóa <i class="fa fa-trash-o"></i></a>      
                                   </td>
                        ...
                        <tfoot>
                            <tr>
                                <td></td>
                                <td>
                                    <a href="http://localhost/Project/Logined" class="btn btn-warning"><i class="fa fa-angle-left"></i> Tiếp tục mua hàng</a>
                                </td>
